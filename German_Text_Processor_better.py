...
currentOutColoredFilePath = 'Texts/Movies/WhoAmI/WhoAmIColored.srt'
...
currentOutFilePath = 'testOut.txt'
...
for i in range(1000):
    ...
    if(line == "/openDict"):
        ...
        currentInFilePath = currentInFilePath
        CleanSRT(OpenText(currentInFilePath), currentInFilePath[:-4]+"Clean.srt")
        currentFile = OpenText(currentInFilePath[:-4]+"Clean.srt")
